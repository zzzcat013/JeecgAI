...
enum Api {
  ...
  knowledgeImportLocal = '/airag/knowledge/doc/import/local',
  knowledgeConfirmSingle = '/airag/knowledge/doc/confirm/single',
}
 ...
 * @param params
 */
export const knowledgeImportLocal = (params) => {
  return defHttp.post({ url: Api.knowledgeImportLocal, data: params }, { isTransformResponse: false });
};
 ...
 * @param params
 */
export const knowledgeConfirmSingle = (params) => {
  return defHttp.post({ url: Api.knowledgeConfirmSingle, data: params }, { isTransformResponse: false });
};
